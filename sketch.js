  ...
  for (let btn of buttons) {
    if (
      ...
      if (btn.label === "Fundamental Wave") {
        window.open("https://parthmevada2307.github.io/Simulation1/");
      }
      
      if (btn.label === "Composite Output") {
        window.open("https://parthmevada2307.github.io/Simulation2/");
      }
      
      if (btn.label === "Superposition Lab") {
        window.open("https://parthmevada2307.github.io/Simulation3/");
      }
    }
  }
}
